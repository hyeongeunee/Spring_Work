...
public class CafeController {
    ...
    public String commentInsert(HttpServletRequest request, int ref_group) {
        ...
        // ref_group 은 원글의 글 번호이기 때문에 원글 자세히 보기로 다시 리다일렉트 이동된다.
    ...
    public String detail(HttpServletRequest request) {
        // 서비스에서 HttpServletRequest 객체를 전달해서 응답에 필요한 데이터가 담기도록 하고
    ...
    public String delete(int num, HttpServletRequest request) {
        // 서비스에서 삭제할 글번호와 HttpServletRequest 객체를 전달해서 해당 글을 삭제시키고
