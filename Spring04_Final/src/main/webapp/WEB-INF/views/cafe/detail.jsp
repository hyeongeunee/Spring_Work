...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/cafe_detail.css">
</head>
<body>
<div class="container">
    ...
    <h3>글 상세 보기</h3>
    <table class="table table-bordered animate__animated animated__bounceIn">
        <tr>
            <th>글번호</th>
            <td>${dto.num }</td>
        </tr>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:if test="${tmp.num ne tmp.comment_group }">
                            ...
                            <svg class="reply-icon bi bi-arrow-return-right" xmlns="http://www.w3.org/2000/svg"
                                 width="16" height="16"
                        ...
                        <dl>
                            <dt>
                                <c:if test="${ empty tmp.profile }">
                                    <svg class="profile-image bi bi-person-circle" xmlns="http://www.w3.org/2000/svg"
                                         width="16" height="16"
                                         fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <c:if test="${tmp.writer eq id }">
                            <form id="updateForm${tmp.num }" class="comment-form update-form" action="comment_update"
                                  method="post">
