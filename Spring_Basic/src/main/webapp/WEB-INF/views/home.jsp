...
<div class="container">
    ...
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/test/json1">JSON 응답받기 1</a></li>
        <li><a href="${pageContext.request.contextPath}/test/json2">JSON 응답받기 2</a></li>
        <li><a href="${pageContext.request.contextPath}/test/json3">JSON 응답받기 3</a></li>
