package com.gura.spring.member;
...
public class MemberController {
    ...
    public String insert(HttpServletRequest request) throws UnsupportedEncodingException {
        // 파라미터 추출은 여기서 ..
        // 폼 전송되는 파라미터 추출하기
        // request.setCharacterEncoding("utf-8"); >> web.xml 에 인코딩 필터 해서 필요 없음
    ...
    public String insert3(MemberDto dto){
        //선언만 하면 알아서 들어감 >> 파라미터명, 필드명 일치시켜야 함
    ...
    public String delete(int num){
        ...
        /*
            리다일렉트 응답을 할 때는 "redirect: 새로 요청할 경로" 형식으로 View page 정보를 작성하면 된다.
         */
        return "redirect:/";
    }
}
